...
var _user$project$Auth$authorize = _elm_lang$core$Native_Platform.outgoingPort(
	'authorize',
	function (v) {
		return [
			{
			isAuthorized: v._0.isAuthorized,
			isAuthorizing: v._0.isAuthorizing,
			token: (v._0.token.ctor === 'Nothing') ? null : v._0.token._0,
			expiresAt: (v._0.expiresAt.ctor === 'Nothing') ? null : v._0.expiresAt._0
		},
			v._1
		];
	});
var _user$project$Auth$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Tick':
				var expiredToken = A2(
					...
					A2(
						...
						function (expiresAt) {
							return _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.cmp(expiresAt, _p0._0) < 0);
						}));
				var tokenNeedsRefresh = model.isAuthorized && (_elm_lang$core$Basics$not(model.isAuthorizing) && expiredToken);
				return tokenNeedsRefresh ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{isAuthorizing: true}),
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Auth$authorize(
							{ctor: '_Tuple2', _0: model, _1: true})
						])) : A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					_elm_lang$core$Native_List.fromArray(
			...
			case 'GetAuthorization':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Auth$authorize(
							{ctor: '_Tuple2', _0: model, _1: _p0._0})
						]));
			case 'GotAuthorization':
				var _p1 = _p0._0;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							isAuthorized: true,
							isAuthorizing: false,
							token: _elm_lang$core$Maybe$Just(_p1.token),
							expiresAt: _elm_lang$core$Maybe$Just(_p1.expiresAt)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{isAuthorized: false, isAuthorizing: false, token: _elm_lang$core$Maybe$Nothing}),
					_elm_lang$core$Native_List.fromArray(
						[]));
		}
	});
var _user$project$Auth$gotAuthorization = _elm_lang$core$Native_Platform.incomingPort(
	'gotAuthorization',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		...
		function (token) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'expiresAt', _elm_lang$core$Json_Decode$float),
				function (expiresAt) {
					return _elm_lang$core$Json_Decode$succeed(
						{token: token, expiresAt: expiresAt});
				});
		}));
var _user$project$Auth$failedAuthorization = _elm_lang$core$Native_Platform.incomingPort(
	'failedAuthorization',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$Auth$Model = F4(
	function (a, b, c, d) {
		return {isAuthorized: a, isAuthorizing: b, token: c, expiresAt: d};
	});
var _user$project$Auth$init = function (storedModel) {
	var model = A4(
...
var _user$project$Auth$FailedAuthorization = {ctor: 'FailedAuthorization'};
var _user$project$Auth$GotAuthorization = function (a) {
	return {ctor: 'GotAuthorization', _0: a};
};
var _user$project$Auth$GetAuthorization = function (a) {
	return {ctor: 'GetAuthorization', _0: a};
};
var _user$project$Auth$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Auth$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Auth$Tick),
				_user$project$Auth$gotAuthorization(_user$project$Auth$GotAuthorization),
				_user$project$Auth$failedAuthorization(
				_elm_lang$core$Basics$always(_user$project$Auth$FailedAuthorization))
			]));
};

var _user$project$Notification$checkPermission = _elm_lang$core$Native_Platform.outgoingPort(
	'checkPermission',
	function (v) {
		return null;
	});
var _user$project$Notification$requestPermission = _elm_lang$core$Native_Platform.outgoingPort(
	'requestPermission',
	function (v) {
		return null;
	});
var _user$project$Notification$notify = _elm_lang$core$Native_Platform.outgoingPort(
	'notify',
	function (v) {
		return [v._0, v._1, v._2];
	});
var _user$project$Notification$updatePermission = _elm_lang$core$Native_Platform.incomingPort('updatePermission', _elm_lang$core$Json_Decode$string);
...
var _user$project$Notification$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$Notification$Model(_user$project$Notification$Default),
	_elm_lang$core$Native_List.fromArray(
		[
			_user$project$Notification$checkPermission(
			{ctor: '_Tuple0'})
		]));
var _user$project$Notification$stringToPermission = function (permission) {
	var _p0 = permission;
	switch (_p0) {
		case 'granted':
...
var _user$project$Notification$onUpdatePermission = F2(
	function (model, permission) {
		return A2(
			...
			_elm_lang$core$Native_Utils.update(
				model,
				{
					permission: _user$project$Notification$stringToPermission(permission)
				}),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _user$project$Notification$update = F2(
	function (msg, model) {
		var _p1 = msg;
		if (_p1.ctor === 'UpdatePermission') {
			return A2(_user$project$Notification$onUpdatePermission, model, _p1._0);
		} else {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Notification$requestPermission(
						{ctor: '_Tuple0'})
					]));
		}
	});
var _user$project$Notification$GetNotificationPermission = {ctor: 'GetNotificationPermission'};
var _user$project$Notification$UpdatePermission = function (a) {
	return {ctor: 'UpdatePermission', _0: a};
};
var _user$project$Notification$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Notification$updatePermission(_user$project$Notification$UpdatePermission)
			]));
};

var _user$project$Types$findById = F2(
	function (id, list) {
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {authorization: a, notification: b, mdl: c, isFetchingChannels: d, lastChannelFetch: e, isFetchingVideos: f, lastVideosFetch: g, timeTillNextVideosFetch: h, channels: i, channelFilter: j, videoFilter: k, selectedTab: l, newVideos: m};
												};
											};
										};
									};
...
var _user$project$Types$Channel = F6(
	function (a, b, c, d, e, f) {
		return {id: a, title: b, thumbnailUrl: c, uploadPlaylist: d, videos: e, shows: f};
	});
var _user$project$Types$Video = F5(
	function (a, b, c, d, e) {
		return {id: a, channelId: b, title: c, thumbnailUrl: d, publishedAt: e};
	});
var _user$project$Types$StoredState = F2(
	function (a, b) {
		return {authorization: a, channels: b};
	});

var _user$project$State$addVideosToChannels = F2(
	function (videos, channels) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (newVideo, channels) {
					var _p0 = A2(_elm_lang$core$Dict$get, newVideo.channelId, channels);
					if (_p0.ctor === 'Nothing') {
						return channels;
					} else {
						var _p2 = _p0._0;
						return A3(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									videos: function () {
										var _p1 = A2(_user$project$Types$findById, newVideo.id, _p2.videos);
										if (_p1.ctor === 'Nothing') {
											return A2(_elm_lang$core$List_ops['::'], newVideo, _p2.videos);
										} else {
											return A2(
												_elm_lang$core$List$map,
												function (video) {
													return _elm_lang$core$Native_Utils.eq(video.id, newVideo.id) ? newVideo : video;
												},
												_p2.videos);
										}
									}()
...
var _user$project$State$addChannelsToChannels = F2(
	function (newChannels, channels) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (newChannel, channels) {
					var _p3 = A2(_elm_lang$core$Dict$get, newChannel.id, channels);
					if (_p3.ctor === 'Nothing') {
						return A3(_elm_lang$core$Dict$insert, newChannel.id, newChannel, channels);
					} else {
						return A3(
							_elm_lang$core$Dict$insert,
							newChannel.id,
...
var _user$project$State$tabs = _elm_lang$core$Array$fromList(
	_elm_lang$core$Native_List.fromArray(
		['main', 'about', 'permissions']));
var _user$project$State$indexToTab = function (index) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'main',
		A2(_elm_lang$core$Array$get, index, _user$project$State$tabs));
};
var _user$project$State$tabToIndex = function (tab) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		_elm_lang$core$List$head(
			A2(
				...
				function (_p4) {
					var _p5 = _p4;
					return _elm_lang$core$Native_Utils.eq(_p5._1, tab) ? _elm_lang$core$Maybe$Just(_p5._0) : _elm_lang$core$Maybe$Nothing;
				},
				_elm_lang$core$Array$toIndexedList(_user$project$State$tabs))));
};
var _user$project$State$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	'setStorage',
	function (v) {
		return {
			authorization: {
				isAuthorized: v.authorization.isAuthorized,
				isAuthorizing: v.authorization.isAuthorizing,
				token: (v.authorization.token.ctor === 'Nothing') ? null : v.authorization.token._0,
				expiresAt: (v.authorization.expiresAt.ctor === 'Nothing') ? null : v.authorization.expiresAt._0
			},
			channels: _elm_lang$core$Native_List.toArray(v.channels).map(
				function (v) {
					return {
						id: v.id,
						title: v.title,
						thumbnailUrl: v.thumbnailUrl,
						uploadPlaylist: v.uploadPlaylist,
						videos: _elm_lang$core$Native_List.toArray(v.videos).map(
							function (v) {
								return {id: v.id, channelId: v.channelId, title: v.title, thumbnailUrl: v.thumbnailUrl, publishedAt: v.publishedAt};
							}),
						shows: _elm_lang$core$Native_List.toArray(v.shows).map(
							function (v) {
								return v;
							})
					};
...
var _user$project$State$requestYTSubscribedChannels = _elm_lang$core$Native_Platform.outgoingPort(
	'requestYTSubscribedChannels',
	function (v) {
		return null;
	});
var _user$project$State$requestYTVideos = _elm_lang$core$Native_Platform.outgoingPort(
	'requestYTVideos',
	function (v) {
...
var _user$project$State$subscribedChannels = _elm_lang$core$Native_Platform.incomingPort(
	'subscribedChannels',
			...
			function (id) {
				return A2(
					...
					function (title) {
						return A2(
							_elm_lang$core$Json_Decode$andThen,
							A2(_elm_lang$core$Json_Decode_ops[':='], 'thumbnailUrl', _elm_lang$core$Json_Decode$string),
							function (thumbnailUrl) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(_elm_lang$core$Json_Decode_ops[':='], 'uploadPlaylist', _elm_lang$core$Json_Decode$string),
										...
										return A2(
												...
												_elm_lang$core$Json_Decode$list(
													A2(
														...
														function (id) {
															return A2(
																_elm_lang$core$Json_Decode$andThen,
																A2(_elm_lang$core$Json_Decode_ops[':='], 'channelId', _elm_lang$core$Json_Decode$string),
																function (channelId) {
																	return A2(
																		_elm_lang$core$Json_Decode$andThen,
																		A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string),
																		function (title) {
																			return A2(
																				...
																				function (thumbnailUrl) {
																					return A2(
																						_elm_lang$core$Json_Decode$andThen,
																						A2(_elm_lang$core$Json_Decode_ops[':='], 'publishedAt', _elm_lang$core$Json_Decode$string),
																						function (publishedAt) {
																							return _elm_lang$core$Json_Decode$succeed(
																								{id: id, channelId: channelId, title: title, thumbnailUrl: thumbnailUrl, publishedAt: publishedAt});
																						});
																				});
																		});
																});
											...
											function (videos) {
												return A2(
													...
													function (shows) {
														return _elm_lang$core$Json_Decode$succeed(
															{id: id, title: title, thumbnailUrl: thumbnailUrl, uploadPlaylist: uploadPlaylist, videos: videos, shows: shows});
													});
											});
									});
							});
...
var _user$project$State$channelFetchComplete = _elm_lang$core$Native_Platform.incomingPort(
	'channelFetchComplete',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$State$channelVideos = _elm_lang$core$Native_Platform.incomingPort(
	'channelVideos',
	_elm_lang$core$Json_Decode$list(
		A2(
			_elm_lang$core$Json_Decode$andThen,
...
var _user$project$State$videoFetchComplete = _elm_lang$core$Native_Platform.incomingPort(
	'videoFetchComplete',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$State$SelectTab = function (a) {
	return {ctor: 'SelectTab', _0: a};
};
var _user$project$State$FilterVideos = function (a) {
	return {ctor: 'FilterVideos', _0: a};
};
var _user$project$State$FilterChannels = function (a) {
	return {ctor: 'FilterChannels', _0: a};
};
var _user$project$State$AddVideos = function (a) {
	return {ctor: 'AddVideos', _0: a};
};
var _user$project$State$VideoFetchComplete = {ctor: 'VideoFetchComplete'};
var _user$project$State$AddSubscribedChannels = function (a) {
	return {ctor: 'AddSubscribedChannels', _0: a};
};
var _user$project$State$ChannelFetchComplete = {ctor: 'ChannelFetchComplete'};
var _user$project$State$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$State$GetNotificationPermission = {ctor: 'GetNotificationPermission'};
var _user$project$State$GetAuthorization = function (a) {
	return {ctor: 'GetAuthorization', _0: a};
};
var _user$project$State$NotificationMsg = function (a) {
	return {ctor: 'NotificationMsg', _0: a};
};
var _user$project$State$AuthMsg = function (a) {
...
var _user$project$State$update = F2(
	function (msg, model) {
		...
		switch (_p6.ctor) {
			...
			case 'AuthMsg':
				var _p7 = A2(_user$project$Auth$update, _p6._0, model.authorization);
				var authModel = _p7._0;
				var authCmd = _p7._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$core$Platform_Cmd$map, _user$project$State$AuthMsg, authCmd)
						]));
			case 'NotificationMsg':
				var _p8 = A2(_user$project$Notification$update, _p6._0, model.notification);
				var notificationModel = _p8._0;
				var notificationCmd = _p8._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$core$Platform_Cmd$map, _user$project$State$NotificationMsg, notificationCmd)
						]));
			case 'GetAuthorization':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_elm_lang$core$Platform_Cmd$map,
							_user$project$State$AuthMsg,
							_user$project$Auth$authorize(
								{ctor: '_Tuple2', _0: model.authorization, _1: _p6._0}))
						]));
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_elm_lang$core$Platform_Cmd$map,
							_user$project$State$NotificationMsg,
							_user$project$Notification$requestPermission(
								{ctor: '_Tuple0'}))
						]));
			case 'Tick':
				var _p9 = _p6._0;
				var timeTillNextVideosFetch = (model.lastVideosFetch + (_elm_lang$core$Time$minute * 20)) - _p9;
				var isAuthorized = model.authorization.isAuthorized;
				if (isAuthorized && (_elm_lang$core$Native_Utils.cmp(_p9 - model.lastChannelFetch, _elm_lang$core$Time$hour * 16) > 0)) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{lastChannelFetch: _p9, isFetchingChannels: true, timeTillNextVideosFetch: timeTillNextVideosFetch}),
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$State$requestYTSubscribedChannels(
								{ctor: '_Tuple0'})
							]));
				} else {
					if (isAuthorized && (_elm_lang$core$Basics$not(model.isFetchingChannels) && (_elm_lang$core$Native_Utils.cmp(timeTillNextVideosFetch, 0) < 1))) {
						var channelPlaylistIds = A2(
							_elm_lang$core$List$map,
							function (_) {
								return _.uploadPlaylist;
							},
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{lastVideosFetch: _p9, isFetchingVideos: true, timeTillNextVideosFetch: timeTillNextVideosFetch}),
							_elm_lang$core$Native_List.fromArray(
								[
									_user$project$State$requestYTVideos(channelPlaylistIds)
								]));
					} else {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'ChannelFetchComplete':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'AddSubscribedChannels':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							channels: A2(_user$project$State$addChannelsToChannels, _p6._0, model.channels),
							lastVideosFetch: 0
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'VideoFetchComplete':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
					...
					_elm_lang$core$Native_Utils.eq(
						_elm_lang$core$List$length(model.newVideos),
						0) ? _elm_lang$core$Native_List.fromArray(
						[]) : _elm_lang$core$Native_List.fromArray(
						[
							_user$project$Notification$notify(
							{
								ctor: '_Tuple3',
								_0: A2(
									_elm_lang$core$Basics_ops['++'],
										...
										function (video, message) {
											return A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													' ',
													A2(_elm_lang$core$Basics_ops['++'], video.title, '.')));
										}),
									'New videos:',
									model.newVideos),
								_2: 'newVideos'
			...
			case 'AddVideos':
				...
				var newVideos = A2(
					...
					A2(
						_elm_lang$core$List$filter,
						function (video) {
							var _p10 = A2(_elm_lang$core$Dict$get, video.channelId, model.channels);
							if (_p10.ctor === 'Nothing') {
								return true;
							} else {
								return _elm_lang$core$Native_Utils.eq(
									A2(_user$project$Types$findById, video.id, _p10._0.videos),
									_elm_lang$core$Maybe$Nothing);
							}
						},
						_p11),
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							channels: A2(_user$project$State$addVideosToChannels, _p11, model.channels),
							newVideos: newVideos
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			...
			default:
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							selectedTab: _p12,
							newVideos: _elm_lang$core$Native_Utils.eq(_p12, 'main') ? _elm_lang$core$Native_List.fromArray(
								[]) : model.newVideos
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Platform_Sub$map,
				_user$project$State$AuthMsg,
				_user$project$Auth$subscriptions(model.authorization)),
				A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$State$NotificationMsg,
				_user$project$Notification$subscriptions(model.notification)),
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$State$Tick),
				_user$project$State$subscribedChannels(_user$project$State$AddSubscribedChannels),
				_user$project$State$channelFetchComplete(
				function (_p13) {
					return _user$project$State$ChannelFetchComplete;
				}),
				_user$project$State$channelVideos(_user$project$State$AddVideos),
				_user$project$State$videoFetchComplete(
				function (_p14) {
					return _user$project$State$VideoFetchComplete;
				})
			]));
};
var _user$project$State$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$State$init = function (maybeStartingState) {
	var _p15 = _user$project$Notification$init;
	var notificationModel = _p15._0;
	var notificationCmd = _p15._1;
	var _p16 = _user$project$Auth$init(
		A2(
			_elm_lang$core$Maybe$andThen,
			maybeStartingState,
			function (_p17) {
	...
	var authModel = _p16._0;
	var authCmd = _p16._1;
	var model = {
		authorization: authModel,
		notification: notificationModel,
		mdl: A2(_debois$elm_mdl$Material_Layout$setTabsWidth, 100, _debois$elm_mdl$Material$model),
		isFetchingChannels: false,
		lastChannelFetch: 0,
		isFetchingVideos: false,
		lastVideosFetch: 0,
		...
		channels: function () {
			var _p18 = maybeStartingState;
			if (_p18.ctor === 'Nothing') {
				return _elm_lang$core$Dict$empty;
			} else {
				return A2(_user$project$State$addChannelsToChannels, _p18._0.channels, _elm_lang$core$Dict$empty);
			}
		}(),
		channelFilter: '',
		videoFilter: '',
		selectedTab: 'main',
		newVideos: _elm_lang$core$Native_List.fromArray(
			[])
	};
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_debois$elm_mdl$Material$init(_user$project$State$Mdl),
				A2(_elm_lang$core$Platform_Cmd$map, _user$project$State$AuthMsg, authCmd),
				A2(_elm_lang$core$Platform_Cmd$map, _user$project$State$NotificationMsg, notificationCmd)
			]));
};

var _user$project$View$videoView = F2(
	function (video, channels) {
		var channel = function () {
			var _p0 = A2(_user$project$Types$findById, video.channelId, channels);
			if (_p0.ctor === 'Nothing') {
				return A6(
					_user$project$Types$Channel,
					'',
					'unknown channel',
					'//s.ytimg.com/yts/img/avatar_720-vflYJnzBZ.png',
					'',
					_elm_lang$core$Native_List.fromArray(
						[]),
					_elm_lang$core$Native_List.fromArray(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('vertical-margin'),
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									{ctor: '_Tuple2', _0: 'margin-bottom', _1: '3px'}
								])),
							_elm_lang$html$Html_Events$onClick(
							_user$project$State$FilterChannels(channel.title)),
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											{ctor: '_Tuple2', _0: 'height', _1: '1.2em'},
											{ctor: '_Tuple2', _0: 'margin-right', _1: '1ex'}
										])),
									_elm_lang$html$Html_Attributes$src(channel.thumbnailUrl),
									_elm_lang$html$Html_Attributes$alt(channel.title)
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							_elm_lang$html$Html$text(channel.title)
						])),
					A2(
					_elm_lang$html$Html$a,
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(_elm_lang$core$Basics_ops['++'], 'http://youtube.com/watch?v=', video.id)),
							_elm_lang$html$Html_Attributes$target('_new')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$width(120),
									_elm_lang$html$Html_Attributes$height(90),
									_elm_lang$html$Html_Attributes$style(
									_elm_lang$core$Native_List.fromArray(
										[
											{ctor: '_Tuple2', _0: 'margin-right', _1: '1em'}
										])),
									_elm_lang$html$Html_Attributes$src(video.thumbnailUrl)
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							_elm_lang$html$Html$text(video.title)
						]))
				]));
	});
var _user$project$View$videosStatus = function (model) {
	var isFetching = model.isFetchingChannels || model.isFetchingVideos;
	return isFetching ? A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('VideosStatus')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Checking for new videos')
			])) : A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$View$videosList = F3(
	function (model, channels, videoFilter) {
		var filterRegex = _elm_lang$core$Regex$caseInsensitive(
			_elm_lang$core$Regex$regex(videoFilter));
		var videos = A2(
			...
			_elm_lang$core$List$reverse(
				A2(
					...
					A2(
						_elm_lang$core$List$filter,
						function (video) {
							return A2(_elm_lang$core$Regex$contains, filterRegex, video.title);
						},
						A2(
							_elm_lang$core$List$concatMap,
							function (_) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('expand-layout no-list horizontal-margin')
				]),
			A2(
				_elm_lang$core$List_ops['::'],
				A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$html$Html_Attributes$placeholder('video filter'),
									_elm_lang$html$Html_Events$onInput(_user$project$State$FilterVideos),
									_elm_lang$html$Html_Attributes$value(videoFilter)
								]),
							_elm_lang$core$Native_List.fromArray(
								[]))
						])),
				A2(
					_elm_lang$core$List_ops['::'],
					_user$project$View$videosStatus(model),
					A2(
						_elm_lang$core$List$map,
						function (v) {
							return A2(_user$project$View$videoView, v, channels);
						},
						videos))));
	});
var _user$project$View$channelList = F2(
	function (channelFilter, channels) {
		return A2(
			_elm_lang$html$Html$ul,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('no-list horizontal-margin')
				]),
			A2(
				_elm_lang$core$List_ops['::'],
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$type$('search'),
									_elm_lang$html$Html_Attributes$placeholder('channel filter'),
									_elm_lang$html$Html_Events$onInput(_user$project$State$FilterChannels),
									_elm_lang$html$Html_Attributes$value(channelFilter),
									_elm_lang$html$Html_Attributes$style(
									_elm_lang$core$Native_List.fromArray(
										[
						...
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_user$project$State$FilterChannels(channel.title)),
									_elm_lang$html$Html_Attributes$class(
									_elm_lang$core$Native_Utils.eq(channel.title, channelFilter) ? 'selected vertical-margin' : 'clickable vertical-margin'),
									_elm_lang$html$Html_Attributes$style(
									_elm_lang$core$Native_List.fromArray(
										[
											{
											...
											_1: A2(
												_elm_lang$core$Basics_ops['++'],
												'url(',
												A2(_elm_lang$core$Basics_ops['++'], channel.thumbnailUrl, ') no-repeat center / cover'))
										},
											{ctor: '_Tuple2', _0: 'padding-top', _1: 'calc(88px - 1em)'},
											{ctor: '_Tuple2', _0: 'width', _1: '10em'}
										]))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
										...
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													{ctor: '_Tuple2', _0: 'background-image', _1: '-webkit-linear-gradient(bottom, black, black, transparent)'},
													{ctor: '_Tuple2', _0: 'padding', _1: '2px 5px'}
												]))
										]),
									_elm_lang$core$Native_List.fromArray(
										[
...
var _user$project$View$mainView = function (model) {
	var filterRegex = _elm_lang$core$Regex$caseInsensitive(
		_elm_lang$core$Regex$regex(model.channelFilter));
	var filteredChannels = A2(
		_elm_lang$core$List$filter,
		function (channel) {
			return A2(_elm_lang$core$Regex$contains, filterRegex, channel.title);
		},
		_elm_lang$core$Dict$values(model.channels));
	return A2(
...
var _user$project$View$about = function (model) {
	...
	var signInRow = model.authorization.isAuthorized ? _elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('signed in')
				])),
			_elm_lang$html$Html$text(' through Google')
		]) : (model.authorization.isAuthorizing ? _elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Signing in'),
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('not signed in')
				])),
			_elm_lang$html$Html$text(' through Google '),
			A5(
			_debois$elm_mdl$Material_Button$render,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$State$GetAuthorization(false))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Google sign-in')
							])),
						A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('https://support.google.com/accounts/answer/112802?hl=en'),
								_elm_lang$html$Html_Attributes$target('_blank')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Learn more about using your Google Account to Sign in to other sites')
							])),
						A3(
						_debois$elm_mdl$Material_Options$styled,
						_elm_lang$html$Html$h3,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Notifications')
							])),
						A2(
						_elm_lang$html$Html$p,
						_elm_lang$core$Native_List.fromArray(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('YoutubeShows')
								]))
						]))
				]),
			...
			tabs: {
				...
				_0: _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$List$isEmpty(model.newVideos) ? _elm_lang$core$Native_List.fromArray(
							[]) : _elm_lang$core$Native_List.fromArray(
							[
						...
						A2(
						_debois$elm_mdl$Material_Options$span,
						(needsAuthorization || needsNotificationPermission) ? _elm_lang$core$Native_List.fromArray(
							[
								_debois$elm_mdl$Material_Badge$add('•')
							]) : _elm_lang$core$Native_List.fromArray(
							[]),
...
var _user$project$YoutubeShows$doSetStorage = F2(
	function (model, cmds) {
		var storedState = A2(
			_user$project$Types$StoredState,
			model.authorization,
			_elm_lang$core$Dict$values(model.channels));
		return {
			ctor: '_Tuple2',
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$State$setStorage(storedState),
						cmds
					]))
		};
	});
var _user$project$YoutubeShows$updateWithStorage = F2(
	function (msg, model) {
		var _p0 = A2(_user$project$State$update, msg, model);
		var newModel = _p0._0;
		var cmds = _p0._1;
		return A2(_user$project$YoutubeShows$doSetStorage, newModel, cmds);
	});
var _user$project$YoutubeShows$location2messages = function (location) {
	var possibleTab = A2(_elm_lang$core$String$dropLeft, 1, location.hash);
	var tab = _elm_lang$core$String$isEmpty(possibleTab) ? 'about' : possibleTab;
	return _elm_lang$core$Native_List.fromArray(
		[
			_user$project$State$SelectTab(tab)
		]);
};
var _user$project$YoutubeShows$delta2url = F2(
...
var _user$project$YoutubeShows$main = {
	main: _rgrempel$elm_route_url$RouteUrl$programWithFlags(
		{init: _user$project$State$init, view: _user$project$View$root, update: _user$project$YoutubeShows$updateWithStorage, subscriptions: _user$project$State$subscriptions, delta2url: _user$project$YoutubeShows$delta2url, location2messages: _user$project$YoutubeShows$location2messages}),
				...
				A2(
					...
					A2(
						...
						A2(
							...
							function (expiresAt) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(_elm_lang$core$Json_Decode_ops[':='], 'isAuthorized', _elm_lang$core$Json_Decode$bool),
									function (isAuthorized) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											A2(_elm_lang$core$Json_Decode_ops[':='], 'isAuthorizing', _elm_lang$core$Json_Decode$bool),
											function (isAuthorizing) {
												return A2(
													...
													function (token) {
														return _elm_lang$core$Json_Decode$succeed(
															{expiresAt: expiresAt, isAuthorized: isAuthorized, isAuthorizing: isAuthorizing, token: token});
													});
											});
									});
							})),
					function (authorization) {
						return A2(
																	...
																	return A2(
																		...
																		function (uploadPlaylist) {
																			return A2(
																												...
																												return A2(
																													...
																													function (thumbnailUrl) {
																														return A2(
																															...
																															function (title) {
																																return _elm_lang$core$Json_Decode$succeed(
																																	{channelId: channelId, id: id, publishedAt: publishedAt, thumbnailUrl: thumbnailUrl, title: title});
																															});
																													});
																											});
																									});
																				...
																				function (videos) {
																					return _elm_lang$core$Json_Decode$succeed(
																						{id: id, shows: shows, thumbnailUrl: thumbnailUrl, title: title, uploadPlaylist: uploadPlaylist, videos: videos});
																				});
																		});
																});
														});
							...
							function (channels) {
								return _elm_lang$core$Json_Decode$succeed(
									{authorization: authorization, channels: channels});
							});
					}))
			]))
};
...
var Elm = {};
Elm['YoutubeShows'] = Elm['YoutubeShows'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['YoutubeShows'], 'YoutubeShows', typeof _user$project$YoutubeShows$main === 'undefined' ? null : _user$project$YoutubeShows$main);
